    ...
    <div>
      <div style={{ backgroundColor: 'var(--bg-card-2)', border: '1px solid var(--border)', padding: '16px 20px', borderRadius: '12px', marginBottom: '24px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <p style={{ margin: 0, color: 'var(--brand-500)', fontSize: '14px', fontWeight: 500, display: 'flex', alignItems: 'center', gap: '8px' }}>
          <AlertCircle size={18} /> 
          Pengingat: Batas waktu pengisian laporan harian adalah jam 17:00 (Sisa waktu: {countdownText})
        </p>
        <button className="btn btn-sm" style={{ backgroundColor: 'var(--bg-card)', color: 'var(--brand-500)', border: '1px solid var(--border)', fontWeight: '500', borderRadius: '8px' }} onClick={() => navigate('/laporan/input')}>Input Laporan</button>
      </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '24px', marginBottom: '24px' }}>
            ...
            <div className="card" style={{ padding: '24px' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '24px' }}>
                <div>
                  <h3 className="font-bold text-lg m-0 text-gray-800">History Laporan Terakhir</h3>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1.2fr 1.5fr 1fr 2fr 1fr', alignItems: 'center', padding: '12px 16px', backgroundColor: 'var(--surface-soft)', borderRadius: '12px', marginBottom: '12px', border: '1px solid var(--border)' }}>
                ...
                <span className="text-xs font-semibold text-gray-500 uppercase tracking-wider">Jenis Laporan</span>
                <span className="text-xs font-semibold text-gray-500 uppercase tracking-wider">Status</span>
                <span className="text-xs font-semibold text-gray-500 uppercase tracking-wider">Keterangan</span>
                <span className="text-xs font-semibold text-gray-500 uppercase tracking-wider text-center">Aksi</span>
              </div>
